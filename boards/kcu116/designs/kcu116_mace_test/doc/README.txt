...
Quick steps to compile and use design [kcu105_mace_test] in RadionHDL
---------------------------------------------------------------------

1.

-> For complete synthesis of this design until bitstream-file do:
    python $RADIOHDL/tools/radiohdl/base/vivado_config.py -t kcu105 -l kcu105_mace_test -r -v3
...
cd ~/PyGemini/GeminiProto/PyGemini
python test.py 

...
create_bd_design "gmi_minimal_axi"
...
connect_bd_net [get_bd_ports mm_clk] [get_bd_pins axi_interconnect_0/M03_ACLK]
connect_bd_net [get_bd_ports mm_clk] [get_bd_pins axi_interconnect_0/M04_ACLK]
connect_bd_net [get_bd_ports mm_clk] [get_bd_pins axi_interconnect_0/M05_ACLK]
...
connect_bd_net [get_bd_ports ph_rst_n] [get_bd_pins axi_interconnect_0/M03_ARESETN]
connect_bd_net [get_bd_ports ph_rst_n] [get_bd_pins axi_interconnect_0/M04_ARESETN]
connect_bd_net [get_bd_ports ph_rst_n] [get_bd_pins axi_interconnect_0/M05_ARESETN]
...
startgroup
create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_LITE_SLAVE_REG_SENS_OPTICS_L
set_property -dict [list CONFIG.NUM_READ_OUTSTANDING [get_property CONFIG.NUM_READ_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M03_AXI]] CONFIG.NUM_WRITE_OUTSTANDING [get_property CONFIG.NUM_WRITE_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M03_AXI]]] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_L]
connect_bd_intf_net [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_L]
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_L]
set_property -dict [list CONFIG.ADDR_WIDTH {5}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_L]
endgroup

startgroup
create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_LITE_SLAVE_REG_SENS_OPTICS_R
set_property -dict [list CONFIG.NUM_READ_OUTSTANDING [get_property CONFIG.NUM_READ_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M04_AXI]] CONFIG.NUM_WRITE_OUTSTANDING [get_property CONFIG.NUM_WRITE_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M04_AXI]]] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_R]
connect_bd_intf_net [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_R]
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_R]
set_property -dict [list CONFIG.ADDR_WIDTH {5}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_OPTICS_R]
endgroup

startgroup
create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_LITE_SLAVE_REG_SENS_PMBUS
set_property -dict [list CONFIG.NUM_READ_OUTSTANDING [get_property CONFIG.NUM_READ_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M05_AXI]] CONFIG.NUM_WRITE_OUTSTANDING [get_property CONFIG.NUM_WRITE_OUTSTANDING [get_bd_intf_pins axi_interconnect_0/xbar/M05_AXI]]] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_PMBUS]
connect_bd_intf_net [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_PMBUS]
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_PMBUS]
set_property -dict [list CONFIG.ADDR_WIDTH {5}] [get_bd_intf_ports AXI4_LITE_SLAVE_REG_SENS_PMBUS]
endgroup
...
assign_bd_address [get_bd_addr_segs {AXI4_LITE_SLAVE_REG_SENS_OPTICS_L/Reg }]
set_property range 4K [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_L_Reg}]
set_property offset 0x40001000 [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_L_Reg}]
set_property range 4K [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_L_Reg}]
set_property offset 0x40001000 [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_L_Reg}]

assign_bd_address [get_bd_addr_segs {AXI4_LITE_SLAVE_REG_SENS_OPTICS_R/Reg }]
set_property range 4K [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_R_Reg}]
set_property offset 0x40002000 [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_R_Reg}]
set_property range 4K [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_R_Reg}]
set_property offset 0x40002000 [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_OPTICS_R_Reg}]

assign_bd_address [get_bd_addr_segs {AXI4_LITE_SLAVE_REG_SENS_PMBUS/Reg }]
set_property range 4K [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_PMBUS_Reg}]
set_property offset 0x40003000 [get_bd_addr_segs {jtag_axi_0/Data/SEG_AXI4_LITE_SLAVE_REG_SENS_PMBUS_Reg}]
set_property range 4K [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_PMBUS_Reg}]
set_property offset 0x40003000 [get_bd_addr_segs {AXI4_LITE_MASTER/SEG_AXI4_LITE_SLAVE_REG_SENS_PMBUS_Reg}]

# Finish, Check and Save:
regenerate_bd_layout
validate_bd_design
save_bd_design
#saved to /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/build/gmi_minimal_axi.srcs/sources_1/bd/gmi_minimal_axi/gmi_minimal_axi.bd

# Optionally derive a wrapper:
make_wrapper -files [get_files /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/build/gmi_minimal_axi.srcs/sources_1/bd/gmi_minimal_axi/gmi_minimal_axi.bd] -top

#VHDL Output written to : /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/build/gmi_minimal_axi.srcs/sources_1/bd/gmi_minimal_axi/hdl/gmi_minimal_axi.vhd
#VHDL Output written to : /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/build/gmi_minimal_axi.srcs/sources_1/bd/gmi_minimal_axi/hdl/gmi_minimal_axi_wrapper.vhd

write_bd_layout -force -format pdf -orientation portrait /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/gmi_minimal_axi.pdf
#written to: /home/hiemstra/svnlowcbf/LOWCBF/Firmware/boards/gemini/designs/gmi_minimal/vivado/bd/src/gmi_minimal_axi.pdf
exit

...
end gmi_led_axi_wrapper;

architecture STRUCTURE of gmi_led_axi_wrapper is
  component gmi_led_axi is
  port (
    mm_clk : in STD_LOGIC;
    mm_rst_n : in STD_LOGIC;
    ph_rst_n : in STD_LOGIC;
  ...
  end component gmi_led_axi;
begin
gmi_led_axi_i: component gmi_led_axi
     port map (

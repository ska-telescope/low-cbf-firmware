...
Quick steps to compile and use design [gmi_heater] in RadionHDL
---------------------------------------------------------------
...
-> For complete synthesis of this design until bitstream-file do:
    python $RADIOHDL/tools/radiohdl/base/vivado_config.py -t gmi -l gmi_heater -r -v3
...
for {set x 0x44a00000} {$x<0x44a00030} {incr x} {

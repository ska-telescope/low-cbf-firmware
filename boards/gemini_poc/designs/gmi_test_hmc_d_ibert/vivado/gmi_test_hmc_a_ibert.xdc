...
##
set_property PACKAGE_PIN AM39 [get_ports gty_refclk0p_i[0]]
set_property PACKAGE_PIN AM40 [get_ports gty_refclk0n_i[0]]
set_property PACKAGE_PIN AL41 [get_ports gty_refclk1p_i[0]]
set_property PACKAGE_PIN AL42 [get_ports gty_refclk1n_i[0]]
set_property PACKAGE_PIN AJ41 [get_ports gty_refclk0p_i[1]]
set_property PACKAGE_PIN AJ42 [get_ports gty_refclk0n_i[1]]
set_property PACKAGE_PIN AG41 [get_ports gty_refclk1p_i[1]]
set_property PACKAGE_PIN AG42 [get_ports gty_refclk1n_i[1]]
set_property PACKAGE_PIN AE41 [get_ports gty_refclk0p_i[2]]
set_property PACKAGE_PIN AE42 [get_ports gty_refclk0n_i[2]]
set_property PACKAGE_PIN AC41 [get_ports gty_refclk1p_i[2]]
set_property PACKAGE_PIN AC42 [get_ports gty_refclk1n_i[2]]
...
## Refclk constraints
##
create_clock -name gtrefclk0_6 -period 5.334 [get_ports gty_refclk0p_i[0]]
create_clock -name gtrefclk1_6 -period 5.334 [get_ports gty_refclk1p_i[0]]
...
create_clock -name gtrefclk0_7 -period 5.334 [get_ports gty_refclk0p_i[1]]
create_clock -name gtrefclk1_7 -period 5.334 [get_ports gty_refclk1p_i[1]]
...
create_clock -name gtrefclk0_8 -period 5.334 [get_ports gty_refclk0p_i[2]]
create_clock -name gtrefclk1_8 -period 5.334 [get_ports gty_refclk1p_i[2]]
...
create_clock -name gtrefclk0_9 -period 5.334 [get_ports gty_refclk0p_i[3]]
create_clock -name gtrefclk1_9 -period 5.334 [get_ports gty_refclk1p_i[3]]
...
set_property PACKAGE_PIN K37 [get_ports ferr_n_tri_i[0]]
set_property IOSTANDARD LVCMOS15 [get_ports ferr_n_tri_i[0]]

set_property PACKAGE_PIN M37 [get_ports iic_main_scl_io]
set_property IOSTANDARD LVCMOS15 [get_ports iic_main_scl_io]

set_property PACKAGE_PIN N37 [get_ports iic_main_sda_io]

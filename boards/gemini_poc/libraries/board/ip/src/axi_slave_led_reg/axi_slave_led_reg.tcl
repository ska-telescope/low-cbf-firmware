...
ipx::associate_bus_interfaces -busif s0_axi -clock "s0_axi_clk" [ipx::current_core]

ipx::remove_memory_map {s0_axi} [ipx::current_core]
ipx::add_memory_map {s0_axi} [ipx::current_core]
set_property slave_memory_map_ref {s0_axi} [ipx::get_bus_interfaces s0_axi -of_objects [ipx::current_core]]
ipx::add_address_block {axi_lite} [ipx::get_memory_maps s0_axi -of_objects [ipx::current_core]]
set_property range {65536} [ipx::get_address_blocks axi_lite -of_objects \
    [ipx::get_memory_maps s0_axi -of_objects [ipx::current_core]]]
